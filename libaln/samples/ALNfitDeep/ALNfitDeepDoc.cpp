...
#define		MESSAGE2  "Creating a overtraining of the domain points to form small clusters."
...
void CALNfitDeepDoc::GenerateReportString()
{
  ...
  // and transfers it to the report string
	...
	const char * apMessages[nMessageCount] = 
	{
		...
		MESSAGE2,  //"Making a overtraining to help create noise variance samples",
